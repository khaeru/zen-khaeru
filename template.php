...
function zen_khaeru_preprocess_html(&$variables, $hook) {
   ...
   * the fonts are mirrored & included locally — see normalize.css.
  drupal_add_css('https://fonts.googleapis.com/css?family=Merriweather:300,400,700,900&subset=latin,latin-ext', array('type' => 'external'));
  */
